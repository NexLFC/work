...
if(filter_input(INPUT_POST,'register')){
    ...
    if(between($safeData['first_name'],2,20)){
        ...
        $errors['first_name']='Please enter your first name, should be within 2-20 characters';
    }

    if(between($safeData['last_name'],2,40)){
        $ln = $dbcl->real_escape_string($safeData['last_name']);
    }else{
        $errors['last_name']='Please enter your last name, should be within 2-40 characters';
    }
    ...
    if($fn&&$ln && $un && $p && $e){
        ...
        if(!$taken){
            ...
            if($stmt->affected_rows == 1){
                $body = "Thank you for registering at nex.com"
